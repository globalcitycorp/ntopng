local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["host_alert_dns_traffic"] = "%{entity}によるDNSトラフィック超過 [値: %{value} %{op} %{threshold}]",
    ...
    ["host_alert_ntp_traffic"] = "%{entity}によるNTPトラフィック超過 [値: %{value} %{op} %{threshold}]",
    ["host_alert_p2p_traffic"] = "%{entity}によるP2Pトラフィック超過 [値: %{value} %{op} %{threshold}]",
    ["host_alert_pkt_threshold"] = "%{entity}によるパケット閾値超過 [値: %{value} %{op} %{threshold}]",
  ...
  ["flow_fields_description"] = {
    ...
    ["post_napt_dst_transport_port"] = "NAPT 後の宛先トランスポートポート",
    ["post_napt_src_transport_port"] = "NAPT 後の送信元トランスポートポート",
  ...
  ["prefs"] = {
    ...
    ["toggle_dst_with_post_nat_dst_description"] = "IPv4宛先アドレス（%%IPV4_DST_ADDR）とポート（%%L4_DST_PORT）をそのポストNAT値（%%POST_NAT_DST_IPV4_ADDRおよび%%POST_NAPT_DST_TRANSPORT_PORT）で置き換えます。",
    ...
    ["toggle_src_with_post_nat_src_description"] = "IPv4ソースアドレス（%%IPV4_SRC_ADDR）およびポート（%%L4_SRC_PORT）をそのポストNAT値（%%POST_NAT_SRC_IPV4_ADDRおよび%%POST_NAPT_SRC_TRANSPORT_PORT）で置き換えます。",
